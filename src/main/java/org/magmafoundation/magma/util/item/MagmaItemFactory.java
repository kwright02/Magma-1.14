...
public class MagmaItemFactory implements ItemFactory {

    static final Color DEFAULT_LEATHER_COLOR = Color.fromRGB(0xA06540);
    static final Collection<String> KNOWN_NBT_ATTRIBUTE_NAMES;
    private static final MagmaItemFactory instance;

    static {
        instance = new MagmaItemFactory();
        ConfigurationSerialization.registerClass(MagmaItemMeta.SerializableMeta.class);
...
//        type = CraftLegacy.fromLegacy(type); // This may be called from legacy item stacks, try to get the right material
        ...
        if (!(meta instanceof MagmaItemMeta)) {
            throw new IllegalArgumentException("Meta of " + meta.getClass().toString() + " not created by " + MagmaItemFactory.class.getName());
        }

        return ((MagmaItemMeta) meta).applicableTo(type);
    }
    ...
    /**
     * @TODO
     * Implement for geting the item meta of items
     *
     * @param meta1
     * @param meta2
     * @return
...
//    private ItemMeta getItemMeta(Material material, MagmaItemMeta meta) {
...
//    }
    ...
    public boolean equals(ItemMeta meta1, ItemMeta meta2) {
        ...
        if (meta1 != null && !(meta1 instanceof MagmaItemMeta)) {
            throw new IllegalArgumentException("First meta of " + meta1.getClass().getName() + " does not belong to " + MagmaItemFactory.class.getName());
        }
        if (meta2 != null && !(meta2 instanceof MagmaItemMeta)) {
            throw new IllegalArgumentException("Second meta " + meta2.getClass().getName() + " does not belong to " + MagmaItemFactory.class.getName());
        }
        if (meta1 == null) {
            return ((MagmaItemMeta) meta2).isEmpty();
        }
        if (meta2 == null) {
            return ((MagmaItemMeta) meta1).isEmpty();
        }

        return equals((MagmaItemMeta) meta1, (MagmaItemMeta) meta2);
    }

    boolean equals(MagmaItemMeta meta1, MagmaItemMeta meta2) {
        /*
    ...
    public static MagmaItemFactory instance() {
        return instance;
    }
    ...
    public ItemMeta asMetaFor(ItemMeta meta, Material material) {
        Validate.notNull(material, "Material cannot be null");
        if (!(meta instanceof MagmaItemMeta)) {
            throw new IllegalArgumentException("Meta of " + (meta != null ? meta.getClass().toString() : "null") + " not created by " + MagmaItemFactory.class.getName());
        }
        return getItemMeta(material, (MagmaItemMeta) meta);
    }
    ...
    public Material updateMaterial(ItemMeta meta, Material material) throws IllegalArgumentException {
        return ((MagmaItemMeta) meta).updateMaterial(material);
    }
