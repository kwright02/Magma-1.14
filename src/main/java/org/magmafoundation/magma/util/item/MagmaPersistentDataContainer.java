...
public class MagmaPersistentDataContainer implements PersistentDataContainer {

    private final Map<String, INBT> customDataTags = new HashMap<String, INBT>();
    private final MagmaPersistentDataTypeRegistry registry;
    private final MagmaPersistentDataAdapterContext adapterContext;

    public MagmaPersistentDataContainer(Map<String, INBT> customTags, MagmaPersistentDataTypeRegistry registry) {
        this(registry);
        this.customDataTags.putAll(customTags);
    }

    public MagmaPersistentDataContainer(MagmaPersistentDataTypeRegistry registry) {
        this.registry = registry;
        this.adapterContext = new MagmaPersistentDataAdapterContext(this.registry);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof MagmaPersistentDataContainer)) {
            return false;
        }

        Map<String, INBT> myRawMap = getRaw();
        Map<String, INBT> theirRawMap = ((MagmaPersistentDataContainer) obj).getRaw();
    ...
    public MagmaPersistentDataTypeRegistry getDataTagTypeRegistry() {
        return registry;
    }
    ...
    public Map<String, Object> serialize() {
        return (Map<String, Object>) MagmaNBTConfigSerializer.serialize(toTagCompound());
    }
