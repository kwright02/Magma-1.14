 ...
 */
public final class MagmaPersistentDataTypeRegistry {
    ...
    private <T> TagAdapter createAdapter(Class<T> type) {
        ...
        if (Objects.equals(PersistentDataContainer.class, type)) {
            return createAdapter(MagmaPersistentDataContainer.class, CompoundNBT.class, MagmaPersistentDataContainer::toTagCompound, tag -> {
                MagmaPersistentDataContainer container = new MagmaPersistentDataContainer(this);
